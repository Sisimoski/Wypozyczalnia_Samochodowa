    ...
    <div class="container">
        <div class="row justify-content-between">
            ...
            <div class="col-lg-3 col-md-6 footer-links">
                ...
                <ul>
                    <li><i class="bx bx-chevron-right"></i> <a href="/index.php">Strona główna</a></li>
                    <li><i class="bx bx-chevron-right"></i> <a href="/oferty.php">Oferty</a></li>
                    <li><i class="bx bx-chevron-right"></i> <a href="/aboutus.php">O nas</a></li>
