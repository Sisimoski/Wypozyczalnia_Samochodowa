        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <h3 class="title">Newsletter</h4>
                 <input type="email" class="form-control d-inline p-2" placeholder="Enter your email"> 
                 <button class="btn d-inline p-2" type="submit">Zapisz się!</button>
                </div>
                <div class="col text-center">
