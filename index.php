            ...
            echo "<button id='zarejestruj' type='submit' class='btn btn-primary my-2 my-sm-0'>Zarejestruj się</button>" ;
                ...
                if(isset($_SESSION['rodzaj_klienta'])){
                    if($_SESSION['rodzaj_klienta'] == 1 || $_SESSION['rodzaj_klienta'] == 2){
                        echo "<button id='panelKlienta' type='submit' class='btn btn-primary my-2 my-sm-0'>Panel Klienta</button>";
                    }
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="widget no-box">
                            ...
                            <a class="btn btn-primary"
                                href="https://www.facebook.com/photo.php?fbid=685853034794823&set=t.100002488671949&type=3"
                                target="_blank">Zarejestruj się</a>
                        </div>
                    </div>
                        ...
                        <div class="widget no-box">
                            ...
                            <ul class="social-footer2">
                                <li class=""><a title="youtube" target="_blank"
                                        href="https://www.facebook.com/photo?fbid=746855902089022&set=pcb.746856305422315"><img
                                ...
                                <li class=""><a
                                        href="https://www.facebook.com/photo?fbid=2234672703233368&set=a.149610995072893"
                                ...
                                <li class=""><a
                                        href="https://www.facebook.com/photo?fbid=1207762415998366&set=p.1207762415998366"
                                        target="_blank" title="Twitter"><img alt="Twitter" width="30" height="30"
                                ...
                                <li class=""><a title="instagram" target="_blank"
                                        href="https://www.facebook.com/photo?fbid=2857377920962910&set=a.204587539575308"><img
