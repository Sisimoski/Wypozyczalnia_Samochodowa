<?php
    ...
    $sth = $db->prepare('SELECT email FROM uzytkownik INNER JOIN kontakty ON kontakty.id_kontakt=uzytkownik.id_uzytkownik WHERE email = :email limit 1');
    $sth ->bindValue(':email',$newMail,PDO::PARAM_STR);
    $sth->execute();
    $result = $sth->fetch(PDO::FETCH_ASSOC);
    if($result){
        die("Podany e-mail już istnieje") ;
    }
                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            <div>
                                <div style="background-color: #9cc9fc;">
                                        ...
                                        <div class="layout__inner"
                                            ...
                                            <div class="column"
                                                ...
                                                <div style="Margin-left: 20px;Margin-right: 20px;">
                                                    <div
                                                        style="mso-line-height-rule: exactly;line-height: 50px;font-size: 1px;">
                                                        &nbsp;</div>
                                                </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <h1 class="size-64"
                                                            ...
                                                            lang="x-size-64"><span class="font-lato"><strong><span
                                                                        style="color:#ffffff">Zmiana maila</span></strong></span></h1>
                                                    </div>
                                                </div>
                                            ...
                                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                                <div
                                                    ...
                                                    <h3
                                                        ...
                                                        <span class="font-lato"><span
                                                                style="color:#18527c">Dokonałeś zmiany maila na nowy adres: '.$newMail.'</span></span></h3>
                                                </div>
                                            </div>
                                            ...
                                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <span class="font-lato">Aby zmienić aktualny adres mail na nowy, prosimy o kliknięcie w poniższy link
                                                            aktywacyjny:</span></p>
                                                </div>
                                            </div>
                                            ...
                                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                                <div class="btn btn--flat btn--medium" style="text-align:center;">
                                                    <![if !mso]><a
                                                        ...
                                                        href="'.$mailChangerLink.'">Zmień adres email</a>
                                                    <![endif]>
                                                </div>
                                            </div>
                                        ...
                                        <div class="layout__inner"
                                            ...
                                            <div class="column"
                                                ...
                                                <div
                                                    style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                                                    <div style="font-size: 12px;line-height: 19px;">
                                                        <!-- <unsubscribe style="text-decoration: underline;">Anuluj subskrypcj&#281;</unsubscribe> -->
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
