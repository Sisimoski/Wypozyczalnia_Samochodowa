 ...
 <div
     class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center border-bottom border-secondary my-2">
 </div>
 <!-- MODUŁY PRACOWNIKA -->
 <?php
 ...
 <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center border-top my-2">
 </div>
