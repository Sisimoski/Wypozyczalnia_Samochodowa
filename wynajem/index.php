<?php
   ...
   // Wchodzimy przez car4you.net.pl/wynajem/index.php?idCar=3      Zamiast 3 id naszego auta;
?>
...
<head>
    ...
    <title>Dane konkretnego Samochodu</title>
...
<?php
   echo "<script> loadCar(".$_GET["idCar"]."); </script>"; 
 ?>
</html>
